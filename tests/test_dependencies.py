...
async def test_get_provider_singleton():
    with patch("api.dependencies.get_settings") as mock_settings:
        ...
        mock_settings.return_value.provider_api_key = "test_key"
        mock_settings.return_value.provider_base_url = "https://test.api.com/v1"
        mock_settings.return_value.provider_rate_limit = 40
        mock_settings.return_value.provider_rate_window = 60
